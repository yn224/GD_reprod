...
if __name__ == '__main__':
    ...
    p4 = Process(target=Logistic_Regression_SAG, args=(X_train, y_train, 0.000625, iterations, 0.01, q4))
    p5 = Process(target=Logistic_Regression_SAGA, args=(X_train, y_train, 0.000625, iterations, 0.01, q5))
